  ...
  return (
    <section className="zd-panel zd-rise zd-d2 rounded-2xl p-5 lg:col-span-2">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-[14px] font-bold text-[#edf4ff]">تكاليف الوقود والصيانة</h2>
          <p className="mt-1 text-[10px] text-[#748aa8]">آخر ٧ أيام · بالريال السعودي</p>
        </div>
        <div className="flex items-center gap-4 text-[10px] text-[#99acc6]">
          ...
          <button className="mr-2 flex items-center gap-1 text-[#75a0ff]">
      ...
      <div className="mt-5 h-[190px] w-full">
        ...
        >
          ...
          {[28, 72, 116, 160, 204].map((y) => (
            <line key={y} x1="0" y1={y} x2="760" y2={y} stroke="#a0b8d8" strokeOpacity=".09" />
          ))}
          <path
          ...
          />
          {days.map((d, i) => (
            <text key={d} x={i * 126 + 5} y="219" fill="#7187a5" fontSize="10">
              {d}
            </text>
          ))}
        </svg>

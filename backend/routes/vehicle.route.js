...
const { createVehicle, listVehicles, listVehicle, changeVehicleStatus, setVehicleToTeam, removerVehicleFromTeam, deleteVehicle } = require("../controllers/vehicle.controller")

router.use(verifyToken)
router.use(getTeam)

router.patch("/:id/assign-to-team", allowedTo(userRoles.ADMIN), setVehicleToTeam)

router.patch("/:id/remove-from-team", allowedTo(userRoles.ADMIN), removerVehicleFromTeam)
